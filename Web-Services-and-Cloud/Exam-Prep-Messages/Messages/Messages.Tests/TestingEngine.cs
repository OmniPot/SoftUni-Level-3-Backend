namespace Messages.Tests
{
    ...
    public static class TestingEngine
    {
        ...
        public static HttpResponseMessage CreateChannelHttpPost(string channelName)
        {
            ...
            var httpPostResponse = HttpClient.PostAsync(
        ...
        public static HttpResponseMessage SendChannelMessageHttpPost(string channelName, string text)
        {
            ...
            var sendMsgUrl = "/api/channel-messages/" + channelName + "/anonymous";
            var httpPostResponse = HttpClient.PostAsync(sendMsgUrl, postContent).Result;
            return httpPostResponse;
        }
            ...
            string channelName, string text, string userSessionToken)
        {
            ...
            httpRequest.RequestUri = new Uri(
                "/api/channel-messages/" + channelName + "/authorized",
                UriKind.Relative);
        ...
        public static HttpResponseMessage DeleteChannelHttpDelete(int channelId)
        {
            var httpPostResponse = HttpClient.DeleteAsync(
                "/api/channels/" + channelId).Result;
            return httpPostResponse;
        }
            ...
            string recipientUsername, string messageText)
        {
            ...
            var httpResponse = HttpClient.PostAsync(
                "/api/user/personal-messages/anonymous", postContent).Result;
            return httpResponse;
        }
            ...
            string senderUserSessionToken, string recipientUsername, string messageText)
        {
            var httpRequest = new HttpRequestMessage();
            httpRequest.Method = HttpMethod.Post;
            httpRequest.RequestUri = new Uri("/api/user/personal-messages/authorized", UriKind.Relative);
            httpRequest.Headers.Authorization =
